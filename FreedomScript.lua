--[[
    ...
    ----========================================----
        ...
        ----========================================----
            ...
            FreedomVehicles:action("Spawn Vehicle", {"freesp"}, "", function(text)
        ...
        players.on_join(function(pid)
            ...
            ----========================================----
                ...
                function(txt)
                    ...
                    upgradecar(vehicle)
                    request_control_of_entity(vehicle)
                    FreedomNotify("\n".."You have spawned: "..util.reverse_joaat(hash).. " for " ..FreedomPName)
                end)
